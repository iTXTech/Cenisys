...
public:
    ...
    promise_handler_base(
        boost::fibers::asio::promise_completion_token<Allocator> const &pct)
    ...
    promise_ptr get_promise() const { return promise_; }
...
public:
    ...
    //<-
    void operator()(T t) { get_promise()->set_value(t); }
    //->
...
public:
    ...
    void operator()() { get_promise()->set_value(); }
...
void asio_handler_invoke(Function f,
                         fibers::asio::detail::promise_handler<T> *h)
{
    typename fibers::asio::detail::promise_handler<T>::promise_ptr p(
        h->get_promise());
    try
    {
        f();
...
public:
    ...
    type get() { return boost::move(value_); }
